...
class ProductDecorator < ApplicationDecorator
  ...
  def product_image(height = nil, width = nil)
    if image.attached?
      ...
      h.image_tag('default-image.jpg', class: 'img-fluid', size: "#{height}x#{width}", alt: description, loading:'lazy')
    end
  end
  ...
  def product_image_thumbnail(height = nil, width = nil)
    if with_image_attached.image.attached?
      ...
      h.image_tag('default-image.jpg', class: 'image-thumbnail', size: "#{height}x#{width}", alt: description, loading:'lazy')
    end
  end
