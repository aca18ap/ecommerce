...
ActiveRecord::Schema.define(version: 2022_05_01_222941) do
  ...
  create_table "businesses", force: :cascade do |t|
    ...
    t.index ["invitation_token"], name: "index_businesses_on_invitation_token", unique: true
    t.index ["invited_by_id"], name: "index_businesses_on_invited_by_id"
    t.index ["invited_by_type", "invited_by_id"], name: "index_businesses_on_invited_by"
  ...
  create_table "faq_votes", force: :cascade do |t|
    ...
    t.index ["ipAddress", "faq_id"], name: "index_faq_votes_on_ipAddress_and_faq_id", unique: true
  end
